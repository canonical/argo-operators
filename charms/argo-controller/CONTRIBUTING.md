...
This document outlines the processes and practices recommended for contributing enhancements to `argo-controller`.
...
# Deploy the charm
juju deploy ./argo-controller_ubuntu@24.04-amd64.charm \
